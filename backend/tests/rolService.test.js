...
describe('RolService', () => {
    ...
    describe('actualizar', () => {
        test('debe actualizar un rol correctamente', async () => {
            ...
            expect(rolRepositoryMock.actualizar).toHaveBeenCalledWith(1, { nombre: 'USER' });
    ...
    describe('asignarPermisos', () => {
        test('debe asignar permisos correctamente', async () => {
            ...
            expect(rolRepositoryMock.asignarPermisos).toHaveBeenCalledWith(1, permisos);
            expect(result).toBe(true);
        });
    ...
    describe('obtenerPermisosPorRol', () => {
