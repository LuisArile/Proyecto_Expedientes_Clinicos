class EstadisticaService {
    ...
    async obtenerResumenGeneral(usuarioSesion) {
        let rolActual = (usuarioSesion.rol || this.rolesPorId[usuarioSesion.idRol] || "").toUpperCase();
        ...
        const filtroId = esAdmin ? null : Number(usuarioSesion.id);
    ...
    async obtenerMedicoData(usuarioSesion, filtroId) {
        ...
        return {
            tarjetas: [
                { id: 'consultasRealizadas', valor: consultasHoy, pie: filtroId ? "Mis atenciones hoy" : "Atenciones totales" },
