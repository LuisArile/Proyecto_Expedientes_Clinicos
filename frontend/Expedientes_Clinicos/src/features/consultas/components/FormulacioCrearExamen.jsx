// src/features/examenes/components/FormularioCrearExamen.jsx
...
export function FormularioCrearExamen() {
  ...
  const { handleCrear, handleActualizar, modal, setModal } = useExamenes();
  ...
  if (data) {
    ...
    setValue(
      "especialidad",
      typeof examen.especialidad === "object"
        ? examen.especialidad?.nombre
        : examen.especialidad
    );
  }
}, [setValue]);
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
              ...
              <div className="flex flex-col sm:flex-row justify-end items-center gap-3 pt-6 border-t">
                <Button
                  ...
                  className="h-11 px-5 border-gray-300 text-gray-600 hover:bg-red-500 hover:text-white transition-all"
                >
                ...
                <Button
                  type="submit"
                  className="h-11 px-6 bg-blue-600 hover:bg-blue-700 text-white font-medium shadow-sm hover:shadow-md transition-all"
                >
